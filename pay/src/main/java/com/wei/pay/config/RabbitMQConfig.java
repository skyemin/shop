...
public class RabbitMQConfig {
    ...
    // 用户服务交换机
    public final static String USER_EXCHANGE = "pay_exchange";
    // 队列名称
    public final static String USER_QUEUE = "pay_queue";
    // 绑定的值
    public static final String USER_BIND_KEY = "pay_bind_key";
